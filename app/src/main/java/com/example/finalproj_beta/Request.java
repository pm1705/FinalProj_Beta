...
public class Request {
    ...
    public Request(boolean approved, boolean pending, boolean relevant, int copies, boolean colorful, boolean vertical, boolean double_sided, String file_id, String user_id, String date_requested, String date_printed, String user_name) {
