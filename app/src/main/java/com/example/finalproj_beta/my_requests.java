...
public class my_requests extends AppCompatActivity implements AdapterView.OnItemClickListener {
            ...
            public void onDataChange(DataSnapshot dS) {
                ...
                for(DataSnapshot data : dS.getChildren()) {
                    if ((boolean) data.child(PENDING).getValue() && !(boolean) data.child(APPROVED).getValue() && (boolean) data.child(RELEVANT).getValue()){
                        ...
                        if (uid.equals(data.child(USER_ID).getValue().toString())){
                ...
                adp = new ArrayAdapter<String>(my_requests.this, R.layout.support_simple_spinner_dropdown_item, displays);
