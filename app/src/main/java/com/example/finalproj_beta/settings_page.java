        ...
        filepath.putFile(image_uri).continueWithTask(new Continuation() {
            ...
            public void onComplete(Task<Uri> task) {
                if (task.isSuccessful()) {
                    ...
                    newRequest = new Request(false, true, true, Integer.parseInt(amount), color, annotation, side, requestName, uid, requestName, print_millis, user_name);
                    refRequests.child("RQ" + requestName).setValue(newRequest);
